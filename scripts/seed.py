...
DEFAULT_SCHEDULED_TASKS = [
    ...
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 6, "cron_hour": 10, "amount": 10000, "from_envelope": "📥 Общий котел", "to_envelope": "🧾 Постоянные расходы"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 6, "cron_hour": 10, "amount": 35000, "from_envelope": "📥 Общий котел", "to_envelope": "🛒 Переменные расходы"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 6, "cron_hour": 10, "amount": 15000, "from_envelope": "📥 Общий котел", "to_envelope": "👨 Личные (Женя)"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 6, "cron_hour": 10, "amount": 15000, "from_envelope": "📥 Общий котел", "to_envelope": "👩‍🦱 Личные (Таня)"},
    ...
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 20, "cron_hour": 20, "amount": 32500, "from_envelope": "📥 Общий котел", "to_envelope": "🎯 Главная Цель"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 21, "cron_hour": 10, "amount": 10000, "from_envelope": "📥 Общий котел", "to_envelope": "🧾 Постоянные расходы"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 21, "cron_hour": 10, "amount": 35000, "from_envelope": "📥 Общий котел", "to_envelope": "🛒 Переменные расходы"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 21, "cron_hour": 10, "amount": 15000, "from_envelope": "📥 Общий котел", "to_envelope": "👨 Личные (Женя)"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 21, "cron_hour": 10, "amount": 15000, "from_envelope": "📥 Общий котел", "to_envelope": "👩‍🦱 Личные (Таня)"},
