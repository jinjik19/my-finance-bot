...
DEFAULT_SCHEDULED_TASKS = [
    ...
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 21, "cron_hour": 21, "amount": 20000, "from_envelope": "📥 Общий котел", "to_envelope": "🧾 Постоянные расходы"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 21, "cron_hour": 21, "amount": 70000, "from_envelope": "📥 Общий котел", "to_envelope": "🛒 Переменные расходы"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 21, "cron_hour": 21, "amount": 30000, "from_envelope": "📥 Общий котел", "to_envelope": "👨 Личные (Женя)"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 21, "cron_hour": 21, "amount": 30000, "from_envelope": "📥 Общий котел", "to_envelope": "👩‍🦱 Личные (Таня)"},
