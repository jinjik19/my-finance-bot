...
DEFAULT_GOALS = [
    ...
    {"name": "Купить машину", "target_amount": 1500000, "linked_envelope_name": "🎯 Главная Цель", "phase_name": "🏠 Фаза 3: Машина"},
...
DEFAULT_SCHEDULED_TASKS = [
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "reminder", "cron_day": 5, "cron_hour": 15, "reminder_text": "🔔 Женя, придет аванс. Пора занести его в 📥 Общий котел."},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 5, "cron_hour": 16, "amount": 32500, "from_envelope": "📥 Общий котел", "to_envelope": "🎯 Главная Цель"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "reminder", "cron_day": 10, "cron_hour": 14, "reminder_text": "🔔 Таня, придвет аванс. Пора занести его в 📥 Общий котел."},
    ...
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "reminder", "cron_day": 20, "cron_hour": 15, "reminder_text": "🔔 Женя, придет зарплата. Пора занести ее в 📥 Общий котел."},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 20, "cron_hour": 16, "amount": 32500, "from_envelope": "📥 Общий котел", "to_envelope": "🎯 Главная Цель"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 21, "cron_hour": 20, "amount": 15000, "from_envelope": "📥 Общий котел", "to_envelope": "🧾 Постоянные расходы"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 21, "cron_hour": 20, "amount": 70000, "from_envelope": "📥 Общий котел", "to_envelope": "🛒 Переменные расходы"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 21, "cron_hour": 20, "amount": 30000, "from_envelope": "📥 Общий котел", "to_envelope": "👨 Личные (Женя)"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "auto_transfer", "cron_day": 21, "cron_hour": 20, "amount": 30000, "from_envelope": "📥 Общий котел", "to_envelope": "👩‍🦱 Личные (Таня)"},
    {"phase_name": "🎯 Фаза 1: Ипотека", "task_type": "reminder", "cron_day": 25, "cron_hour": 13, "reminder_text": "🔔 Таня, придет зарплата. Пора занести ее в 📥 Общий котел."},

    {"phase_name": "🚀 Фаза 2: Переезд", "task_type": "auto_transfer", "cron_day": 5, "cron_hour": 16, "amount": 57500, "from_envelope": "📥 Общий котел", "to_envelope": "🎯 Главная Цель"},
    {"phase_name": "🚀 Фаза 2: Переезд", "task_type": "auto_transfer", "cron_day": 20, "cron_hour": 16, "amount": 57500, "from_envelope": "📥 Общий котел", "to_envelope": "🎯 Главная Цель"},

    {"phase_name": "🏠 Фаза 3: Машина", "task_type": "auto_transfer", "cron_day": 5, "cron_hour": 16, "amount": 20000, "from_envelope": "📥 Общий котел", "to_envelope": "🏦 На пенсию"},
    {"phase_name": "🏠 Фаза 3: Машина", "task_type": "auto_transfer", "cron_day": 5, "cron_hour": 16, "amount": 37500, "from_envelope": "📥 Общий котел", "to_envelope": "🎯 Главная Цель"},
